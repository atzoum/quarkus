...
class HibernateValidatorProcessor {
    ...
    public void build(HibernateValidatorRecorder recorder, RecorderContext recorderContext,
            ...
            BuildProducer<BeanContainerListenerBuildItem> beanContainerListenerBuildItem) throws Exception {
        ...
        beanContainerListenerBuildItem
                .produce(new BeanContainerListenerBuildItem(recorder.initializeAfterBeanContainer(classesToBeValidated)));
